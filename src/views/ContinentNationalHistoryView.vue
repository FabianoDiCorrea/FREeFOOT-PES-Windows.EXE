        ...
        <table class="table table-dark align-middle mb-0" style="font-size: 0.75rem; border-collapse: separate; border-spacing: 0 4px;">
          ...
          <tbody>
            <tr v-for="team in sortedTeams" :key="team.nome" class="club-row">
              <td class="ps-3 fw-black text-uppercase border-none cursor-pointer" @click="$router.push({ name: 'nationalHistory', params: { id: team.nome } })">
                <div class="d-flex align-items-center gap-2">
                  <NationalFlag :countryName="team.nome" :size="20" />
                  <span class="name-cell-full d-flex align-items-center gap-1 text-hover-info text-decoration-underline-hover">
                    {{ team.nome }}
                  </span>
                </div>
              </td>
