    ...
    <div class="d-flex justify-content-between align-items-center mb-4 px-2">
      <div class="d-flex align-items-center gap-3">
        ...
        <div class="d-flex gap-2">
          <GameButton class="btn-sm btn-info text-white fw-bold shadow-lg" @click="$router.push('/carreira/resumo')">
            <i class="bi bi-bar-chart-fill me-1"></i> MINHAS ESTATÍSTICAS
          </GameButton>
