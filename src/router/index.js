...
const router = createRouter({
    ...
    routes: [
        ...
        { path: '/continente/:id/historico', name: 'continentHistory', component: () => import('../views/ContinentNationalHistoryView.vue') },
        ...
        { path: '/acr-treinamento', name: 'acr-training', component: () => import('../views/OcrTrainingView.vue') },
    ],
});
